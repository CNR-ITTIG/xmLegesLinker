...
char* _configSeparExt = "#";
char* _configSeparInt = "#";
...
/******************************************************************************/
/******************************************* CONFIG GET SEPAR. RIF ESTERNI ****/
/******************************************************************************/
char* configGetSeparExt(void) {
	return _configSeparExt;
}


/******************************************************************************/
/******************************************* CONFIG SET SEPAR. RIF ESTERNI ****/
/******************************************************************************/
void configSetSeparExt(char* separatore) {
	_configSeparExt = strdup(separatore);
}


/******************************************************************************/
/******************************************* CONFIG GET SEPAR. RIF INTERNI ****/
/******************************************************************************/
char* configGetSeparInt(void) {
	return _configSeparInt;
}


/******************************************************************************/
/******************************************* CONFIG SET SEPAR. RIF INTERNI ****/
/******************************************************************************/
void configSetSeparInt(char* separatore) {
	_configSeparInt = strdup(separatore);
}
